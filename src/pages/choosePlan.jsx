    ...
    return (
        <div className="sm:basis-[60%] w-[300px] sm:w-[100%] h-[100%] sm:pr-[80px]">
            ...
            <form onSubmit={handleSumbit} className="flex flex-col relative">
                <div
                    className={`${toggleYearly ? "hidden" : "block"
                    ...
                    {monthlyPlans.map((item, idx) => {
                        return (
                            <div
                                ...
                                key={item.id}
                                className={`plan ${num != idx + 1 ? "bg-white" : "bg-primary-lightBlue"
                                    } border-2 ${num != idx + 1
                ...
                <div
                    className={`${toggleYearly ? "block" : "hidden"
                ...
                <div
                    className={`bg-neutral-alabaster flex justify-center items-center py-3 space-x-8 rounded-md ${toggleYearly ? "mb-[70px]" : "mb-[77px]"
                        } ${toggleYearly ? "sm:mb-[79px]" : "sm:mb-[97px]"
                        }`}
                >
                    <p
                        className={`${toggleYearly ? "text-neutral-coolGray" : "text-primary-marineBlue"
                            } text-[14px] font-[500]`}
                    >
                        Monthly
                    </p>
                ...
                <div className="flex justify-between items-center">
                    <button
                        onClick={() => navigate("/")}
                        className="bg-primary-marineBlue text-black bg-red-500 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded rounded-md px-6 py-3 transition-all duration-300 hover:opacity-75"
                    >
                        Go back
                    </button>

                    <button
                        className="bg-primary-marineBlue text-black bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded rounded-md px-6 py-3 transition-all duration-300 hover:opacity-75"
                        type="sumbit"
                    >
                        Next Step
                    </button>
